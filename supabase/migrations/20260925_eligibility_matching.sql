...
-- 2. Cached Eligibility Match Results (refreshed on notification publish or profile update)
...
-- 4.1 Policies for Candidate Eligibility Preferences
...
-- 4.2 Policies for Eligibility Matches
